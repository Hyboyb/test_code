  ...
  return (
    <div className="flex flex-col py-[20px]">
      <div className="grid-cols-[repeat(4,1fr)] grid justify-center mt-[20px] gap-[20px]">
        <p className="text-center border-stone-500 p-[10px]">Hình ảnh</p>
        <p className="text-center border-stone-500 p-[10px]">Tên sản phẩm</p>
        <p className="text-center border-stone-500 p-[10px]">Giá</p>
        <p className="text-center border-stone-500 p-[10px]">Hành động</p>
      </div>
